	...
	res.status(200).json({
		...
		data: [
			...
			},
			{
				...
				mainImage:
					'./images/cameras/christian-fregnan-oSruNLr68yc-unsplash.jpg',
				images: [],
			},
			{
				oldPrice: '199.99',
			...
			},
			{
				...
				mainImage:
					'./images/cameras/christian-lambert-EXl7WUg9QNU-unsplash.jpg',
				images: [],
			},
			{
				oldPrice: '',
				...
				mainImage:
					'./images/cameras/christian-lambert-z4gbqMunm5s-unsplash.jpg',
				images: [],
			},
			{
				oldPrice: '129.99',
				...
				mainImage:
					'./images/cameras/sharon-mccutcheon-EUVlsS39z2Q-unsplash.jpg',
